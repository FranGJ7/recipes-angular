...
import { SimilarRecipeComponent } from './components/pages/single-recipe/main-information/similar-recipe/similar-recipe.component' // import essencial para usar http em toda aplicação
